    ...
    if (reader->take_next_sample(&st, &info) == ReturnCode_t::RETCODE_OK)
    {
        if (info.valid_data)
        {
            ...
            if (st.wasFast())
            {
                ...
                // st.message();
                std::cout << "Sample received from fast writer, message: " << st.message()[0] << std::endl;
                // for (auto it = st.message().begin(); it != st.message().end(); ++it )
                //     std::cout << ' ' << *it;
                // std::cout << '\n';
            }
            else
            {
                ...
                // st.message();
                std::cout << "Sample received from slow writer, message: " << st.message()[0] << std::endl;
                // for (auto it = st.message().begin(); it != st.message().end(); ++it )
                //     std::cout << ' ' << *it;
                // std::cout << '\n';
            }
